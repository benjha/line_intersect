...
void initEarlyGLXfnPointers()
{
	...
	{
		std::cout << "Warning! unable to allocate glXCreateContextAttribsARB \n ";
	}
...
//=======================================================================================
//
void CreateWindow(RenderContext *rcx, const char* display, int mayorGLversion, int minorGLversion, bool stereo)
{
...
//    cout << "Mapped window 1" << endl;
    ...
    // Also create a new GL 4.x context for rendering
    GLint attribs[9];
...
//    cout << "XSync " << endl;
    ...
    if ( !ctxErrorOccurred && rcx->ctx )
    	cout << "Created windowless GL " << mayorGLversion << "." << minorGLversion << " context\n";
       	...
       	cout << "Unable to create windowless GL " << mayorGLversion << "." << minorGLversion << " context\n";
